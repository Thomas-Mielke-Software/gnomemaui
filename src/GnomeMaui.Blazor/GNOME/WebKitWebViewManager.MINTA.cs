...
// class WebKitWebViewManager : WebViewManager, IAsyncDisposable
// {
// 	const string Scheme = "app";
// 	static readonly Uri BaseUri = new($"{Scheme}://localhost/");
// 	readonly UserContentManager? _userContentManager;
// 	readonly WebView _webView;
// 	readonly BlazorWebViewOptions _options;
// 	readonly ILogger<WebKitWebViewManager>? _logger;

// 	public WebKitWebViewManager(WebView webView, IServiceProvider serviceProvider) : base(
// 		serviceProvider,
...
// 	{
// 		_options = serviceProvider.GetRequiredService<BlazorWebViewOptions>();
...
// 			uri = requestPath == "/"
// 				? uri + _options.RelativeHostPath
// 				: BaseUri.ToString() + _options.RelativeHostPath;
// 		}
...
// 	void WebviewInteropMessageReceived(UserContentManager sender, UserContentManager.ScriptMessageReceivedSignalArgs args)
// 	{
// 		var result = args.Value;
// 		MessageReceived(BaseUri, result.ToString());
// 	}

// 	Widget NavigationSignalHandler(WebView sender, WebView.CreateSignalArgs args)
// 	{
// 		var navigationType = Internal.NavigationAction.GetNavigationType(args.NavigationAction.Handle);
// 		if (navigationType != NavigationType.LinkClicked)
// 		{
// 			return default!;
// 		}

// 		var request = Internal.NavigationAction.GetRequest(args.NavigationAction.Handle);
// 		var nonNullableUtf8StringUnownedHandle = Internal.URIRequest.GetUri(request);
...
// 		_webView.OnCreate -= NavigationSignalHandler;
// 		if (_userContentManager is null)
// 		{
// 			return;
// 		}
